...
class AppointmentRepository(BaseRepository):
    ...
    async def get_upcoming_for_patient(self, patient_id: UUID, from_datetime: datetime | None = None):
    ...
    async def get_upcoming_for_provider(self, provider_id: UUID, from_datetime: datetime | None = None):
        if from_datetime is None:
            from_datetime = datetime.utcnow()
